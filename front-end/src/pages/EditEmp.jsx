...
fetchEmployee()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
    const res = await axios.put(`http://localhost:5000/api/employees/${id}`,newEmployee)
  ...
  return (
    <div className="rounded-lg border bg-card text-card-foreground shadow-sm max-w-md mx-auto p-6 sm:p-8">
      <div className="flex flex-col space-y-1.5 p-6">
        <h3 className="whitespace-nowrap tracking-tight text-2xl font-bold">Edit Employee</h3>
